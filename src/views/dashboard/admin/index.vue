  ...
  <div class="dashboard">
    ...
    <el-row class="infoCrads">
      <el-col :span="6">
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to class="cardItem_p0 color-green1"
                      :startVal="startVal"
                      :endVal="vistors"
      ...
      <el-col :span="6">
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to class="cardItem_p0 color-blue"
                      :startVal="startVal"
                      :endVal="message"
                      :duration="2000"></count-to>
      ...
      <el-col :span="6">
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to class="cardItem_p0 color-red"
                      :startVal="startVal"
                      :endVal="order"
                      :duration="2000"></count-to>
      ...
      <el-col :span="6">
        <div class="cardItem">
          <div class="cardItem_txt">
            <count-to class="cardItem_p0 color-green2"
                      :startVal="startVal"
                      :endVal="profit"
                      :duration="2000"></count-to>
    ...
    <!-- end -->
    <!-- lineEcharts -->
    <line-charts class="lCharts"
                 :lineChartData="lineChartData"></line-charts>
    <!-- end -->
    <!-- table and pie -->
    <el-row class="tableChart">
      <el-col :span="16">
        <table-show :tableData="tableData"
                    class="tableShow"></table-show>
      </el-col>
      <el-col :span="8">
    ...
    <!-- end -->
    <!-- bar chart -->
    <bar-charts class="barCharts"
                :barData="barData"></bar-charts>
    <!-- end -->
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    jump() {
      this.$router.push('/imformation-manage/base-table')
    }
  }
}
</script>
