    ...
    <el-card class="anoCard">
      ...
      <div class="searchDiv">
        <el-input type="text"
                  placeholder="请输入订单号"
                  class="width1"
                  v-model="sch_order"></el-input>
        <el-select v-model="sch_status"
                   clearable
                   class="width1"
                   placeholde="请选择状态">
        ...
        <el-table-column label="操作"
          ...
          <template slot-scope="scope">
            ...
            <el-button type="warning"
                       ...
                       :disabled="scope.row.status === 1 ? false : true">审核</el-button>
            <el-button type="success"
                       @click="toSuccess(scope.row)"
                       :disabled="scope.row.status === 2 ? false : true">完成</el-button>
            <el-button type="danger"
                       @click="toDelete(scope.row)"
                       :disabled="scope.row.status !== 3 ? false : true">取消</el-button>
          </template>
        </el-table-column>
      </el-table>
